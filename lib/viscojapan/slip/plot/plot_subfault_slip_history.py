...
class SubFaultSlipHistoryPlotter(object):
    ...
    def plot(self, output_file,
        ...
        cumu_slip3d = self.slip.cumu_slip3d
        num_subflts_strike = self.slip.num_subflt_along_strike
        num_subflts_dip = self.slip.num_subflt_along_dip
