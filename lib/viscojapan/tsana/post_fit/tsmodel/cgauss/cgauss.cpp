...
int pivoting(double *A, int nrow_A, int ncol_A, double *B, int nrow_B, int ncol_B, int csz);
...
pivoting(PyObject *self, PyObject *args)
{
	...
	pivoting(A, nrow_a, ncol_a, B, nrow_b, ncol_b, csz);	
...
extern "C" PyMODINIT_FUNC initcgauss(void);
