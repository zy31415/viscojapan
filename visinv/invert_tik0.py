...
from viscojapan.tikhonov_regularization import TikhonovZerothOrder
...
# regularization
reg = TikhonovZerothOrder(nrows_slip=10, ncols_slip=25)
...
for nth, alpha in enumerate(logspace(-5,3,30)):
    ...
    solution = inv()
    with open('outs_tik0/res_%02d.pkl'%nth,'wb') as fid:
