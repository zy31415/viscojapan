...
#mean_percentage_Rco = np.mean(Rco/total, axis=1)
...
plt.plot(epochs[1:], mean_percentage_Easlip,'o-', label=r'$E^{\bf{aslip}}$')
plt.plot(epochs[1:], mean_percentage_Rco,'^-', label = r'$R^{\bf{co}}$')
plt.plot(epochs[1:], mean_percentage_Raslip,'v-', label = r'$R^{\bf{aslip}}$')
