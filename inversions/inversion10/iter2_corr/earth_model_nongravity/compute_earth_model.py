...
fid = vm.fm.FaultFileReader('../fault_model/fault_bott80km.h5')
...
add_model('He50km_VisM6.3E18', lmax, 0)
add_model('He50km_VisM1.0E19', lmax, 1)
add_model('He60km_VisM6.3E18', lmax, 2)
