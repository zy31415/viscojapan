...
subflts_files_rake84 = \
              sorted(glob.glob('../fault_model/subflts_bott80km_rake84/flt_????'))

subflts_files_rake85 = \
              sorted(glob.glob('../fault_model/subflts_bott80km_rake85/flt_????'))
...
add_task_nongravity('He46km_VisM8.9E18', 84, 0)
add_task_nongravity('He46km_VisM9.9E18', 84, 1)
add_task_nongravity('He50km_VisM8.9E18', 84, 2)
add_task_nongravity('He46km_VisM8.9E18', 85, 3)
