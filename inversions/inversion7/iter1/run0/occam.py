...
inv = vj.OccamDeconvolutionSeparateCoPost2(
    file_G0 = '../green_function/G_He50km_VisK5.0E17_VisM1.0E19_Rake90.h5',
    
    files_Gs = ['../green_function/G_He50km_VisK6.0E17_VisM1.0E19_Rake90.h5',
                '../green_function/G_He50km_VisK5.0E17_VisM2.0E19_Rake90.h5',
                '../green_function/G_He55km_VisK5.0E17_VisM1.0E19_Rake90.h5',
                '../green_function/G_He55km_VisK5.0E17_VisM1.0E19_Rake85.h5',
                ],
    nlin_par_names = ['log10(visK)', 'log10(visM)','log10(He)','rake'],
