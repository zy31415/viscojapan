...
from viscojapan.inversion.occam_deconvolution2 import OccamDeconvolution2
...
inv = OccamDeconvolution2(
    file_G0 = '../../greens_function/G_Rake90.h5',
    files_Gs = ['../../greens_function/G_Rake80.h5'],
    nlin_par_names = ['rake'],
